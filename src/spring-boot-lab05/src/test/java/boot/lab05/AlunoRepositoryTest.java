...
import com.cavalari.lab05.Aluno;
import com.cavalari.lab05.AlunoRepository;
...
public class AlunoRepositoryTest {
	...
	public void testSaveAluno() throws Exception {
		Aluno aluno = Aluno.builder()
				.nome("Cesar").matricula(67676)
				.email("cesarcavalari@gmail.com").dataNascimento(new Date()).build();
	...
	public void testFindByNome() throws Exception {
		...
		List<Aluno> alunos = repository.findByNomeContaining("Cesar");
		
		assertNotNull(alunos);
		assertFalse(alunos.isEmpty());
		assertTrue(alunos.get(0).getNome().equals("Cesar"));
	}
