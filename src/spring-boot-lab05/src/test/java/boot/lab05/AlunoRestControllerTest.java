...
import com.cavalari.lab05.AlunoRestController;
...
public class AlunoRestControllerTest {
	...
	public void testCreate() throws Exception {
		Aluno aluno = new Aluno(6l, "Cesar", 66666, "cesarcavalari@gmail.com", new Date());
		mockMvc.perform(post("/alunos").contentType(MediaType.APPLICATION_JSON_UTF8)
				...
				.andExpect(jsonPath("$.nome", equalTo("Cesar")));
	}
